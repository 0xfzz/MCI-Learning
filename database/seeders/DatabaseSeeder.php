...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Create Categories
        $frontend = Category::updateOrCreate(
        ...
        $backend = Category::updateOrCreate(
        ...
        $database = Category::updateOrCreate(
            ["slug" => "database"],
            [
                "name" => "Database",
                "slug" => "database",
        ...
        $laravelCourse = Course::updateOrCreate(
        ...
        $flutterCourse = Course::updateOrCreate(
        ...
        $reactSection1 = Lesson::updateOrCreate(
            [
        ...
        $reactSection2 = Lesson::updateOrCreate(
            [
                "course_id" => $reactCourse->course_id,
        ...
        $laravelSection1 = Lesson::updateOrCreate(
            [
