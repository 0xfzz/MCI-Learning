...
<form method="POST" action="{{ route('instructor.lessons.store', $course) }}" class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl p-6 space-y-6">
    @csrf
    @include('instructor.lessons.form', ['lesson' => null])
