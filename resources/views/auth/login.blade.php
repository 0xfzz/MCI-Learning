...
@section('title', 'Masuk ke MCI Learning')
...
<div class="min-h-screen flex items-center justify-center px-6 py-16">
    <div class="max-w-md w-full bg-white dark:bg-gray-900 border border-teal-500/20 dark:border-teal-400/20 rounded-3xl shadow-[0_25px_60px_rgba(20,184,166,0.18)] p-10">
        ...
        <p class="mt-8 text-center text-xs text-gray-500 dark:text-gray-400">
            Tidak punya akun? <a href="{{ route('register') }}" class="font-semibold text-teal-600 dark:text-teal-300 hover:text-teal-500">Daftar sekarang</a>.
        </p>
